...
import com.github.copy.bookstore.infrastructure.plug.security.user.AuthenticAccountDetailsService;
 ...
 * <p>
 * 在该配置中，设置了授权服务Endpoint的相关信息
 * （端点的位置、请求方法、使用怎样的令牌、支持怎样的客户端）
 * 以及针对OAuth2的密码模式所需要的用户身份认证服务和用户详情查询服务
 *
 * @author Jxin
 * @since 2021/4/8 1:12 上午
 */
@AllArgsConstructor
@Configuration
public class AuthorizationServerConfiguration extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoint) {
        endpoint.authenticationManager(authenticationManager)
                .userDetailsService(authenticAccountDetailsService)
